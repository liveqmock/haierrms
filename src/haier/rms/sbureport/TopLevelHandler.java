...
/**
 * 获取SBS FTP过来的文件中的数据 处理后存入CUBE中
 * 1、通过FTP获取SBS文件
 * 2、分析3个文本文件，生成6001，6002数据，存入CUBE中
 * User: zhanrui
 * Date: 2010-6-2
 */
public class TopLevelHandler extends AbstractMainETL {
    ...
    public void processCurrYearData(String strStartDate, String strEndDate, String bussItem) {
        ...
        do{
            ...
            logger.info("TOPLEVEL表的数据：" + strCurrDate + "已生成完成。");
