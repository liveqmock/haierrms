...
public class CubeFactFcstInfo {
    ...
    public String getTag_fcst_type() {
        return tag_fcst_type;
    }

    public void setTag_fcst_type(String tag_fcst_type) {
        this.tag_fcst_type = tag_fcst_type;
    }
}